...
use teo_parser::expr::{ReferenceInfo, ReferenceType};
use teo_parser::r#type::reference::Reference;
use teo_parser::r#type::Type;
use teo_parser::search::search_identifier_path::{search_identifier_path_names_with_filter_to_expr_info};
...
pub fn fetch_unit<I>(unit: &Unit, schema: &Schema, info_provider: &I, expect: &Type, namespace: &namespace::Builder, diagnostics: &mut Diagnostics) -> Result<Value> where I: InfoProvider {
...
fn fetch_current_item_for_unit<I>(current: Option<UnitFetchResult>, expression: &Expression, schema: &Schema, info_provider: &I, expect: &Type, namespace: &namespace::Builder, diagnostics: &mut Diagnostics) -> Result<UnitFetchResult> where I: InfoProvider {
