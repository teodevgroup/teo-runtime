...
pub fn fetch_argument_list<I>(argument_list: &ArgumentList, schema: &Schema, info_provider: &I, namespace: &Namespace, diagnostics: &mut Diagnostics) -> Result<Arguments> where I: InfoProvider {
...
pub fn fetch_argument_list_or_empty<I>(argument_list: Option<&ArgumentList>, schema: &Schema, info_provider: &I, namespace: &Namespace, diagnostics: &mut Diagnostics) -> Result<Arguments> where I: InfoProvider {
